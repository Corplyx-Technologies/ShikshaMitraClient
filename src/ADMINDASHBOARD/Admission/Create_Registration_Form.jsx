...
function Create_Registration_Form() {
  ...
  useEffect(() => {
    ...
    axios.get('https://grumpy-plum-dalmatian.cyclic.app/api/v1/adminRoute/getLastYearStudents', {
  ...
  return (
    <div className=" mt-12  w-[900px] mx-auto p-3">
      <h1 className="text-2xl font-bold mb-4 uppercase text-center text-cyan-700"> New Registration</h1>
      <button
        onClick={openModal}
