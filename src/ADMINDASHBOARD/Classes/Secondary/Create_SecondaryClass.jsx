...
function Create_SecondaryClass() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/getAllClass?primary=${false}`,
        {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = axios.post(
        "https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/createClass",
        formData,
        {
          withCredentials: true,
          headers: {
  ...
  const handleDelete = async (className) => {
    try {
      const re = await axios.get(
        `https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/getAllClass?className=${className}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
      ...
      const response = await axios.delete(
        `https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/deleteClass?_id=${re.data.classList[0]._id}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
