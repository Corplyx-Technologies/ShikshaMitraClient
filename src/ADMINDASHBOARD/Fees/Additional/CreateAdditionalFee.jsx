...
function CreateAdditionalFee() {
  ...
  useEffect(() => {
    axios.get('https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/getAdditionalFees', {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/createAdditionalFees",
        formDataToSend,
        {
          withCredentials: true,
          headers: {
  ...
  const handleDelete = (itemId) => {
    axios.delete(`https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/deleteFees/${itemId}`, 
    {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
