...
function CreateParents() {
  ...
  useEffect(() => {
    ...
    axios.get('https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/getAllParents', 
    {
  ...
  const handleDelete = (email) => {
    axios.put(`https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/deactivateParent`, {email}, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
