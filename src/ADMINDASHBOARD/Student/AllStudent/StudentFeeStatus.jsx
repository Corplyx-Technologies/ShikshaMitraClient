...
const StudentFeeStatus = () => {
  ...
  const handleModalOpen = () => {
    axios
      .get(`https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/getFees`, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  const handleSubmit = () => {
    ...
    const apiUrl = "https://real-ruby-dolphin-fez.cyclic.app/api/v1/fees/createFeeStatus";
    axios
      ...
      .then((response) => {
        ...
        axios
          .get(
            `https://real-ruby-dolphin-fez.cyclic.app/api/v1/fees/getFeeStatus?studentId=${studentId}`,
            {
              withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
  ...
  useEffect(() => {
    ...
    axios
      .get("https://real-ruby-dolphin-fez.cyclic.app/api/v1/adminRoute/getAdditionalFees", {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
