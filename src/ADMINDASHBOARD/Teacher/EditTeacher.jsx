...
const EditTeacher = () => {
  ...
  useEffect(() => {
    axios.get(
      `https://tiny-tan-wombat-shoe.cyclic.app/api/v1/adminRoute/getTeachers?email=${email}`,
      {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios.put(`https://tiny-tan-wombat-shoe.cyclic.app/api/v1/adminRoute/updateTeacher`, data, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
