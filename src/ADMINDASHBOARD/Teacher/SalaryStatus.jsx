...
const SalaryStatus = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://precious-pink-nightgown.cyclic.app/api/v1/adminRoute/getTeachers?email=${email}`, {
  ...
  useEffect(() => {
    if (teacherId) {
      axios
        .get(`https://precious-pink-nightgown.cyclic.app/api/v1/teacher/getPaymentHistory?teacherId=${teacherId}`, {
          withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
