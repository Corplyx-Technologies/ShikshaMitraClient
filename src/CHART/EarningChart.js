...
const EarningChart = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://precious-pink-nightgown.cyclic.app/api/v1/employee/salaryExpensesMonths', {
      withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
  ...
  return (
    <div className="w-full">
      <h2 className="text-xl font-bold text-cyan-700 mb-4">Fee Income and Expenses According to Months</h2>
      <div id="chart">
        <ReactApexChart
