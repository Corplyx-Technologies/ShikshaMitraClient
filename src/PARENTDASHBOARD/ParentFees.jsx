...
const ParentFees = () => {
  ...
  // useEffect(() => {
  //   axios.get("https://handsome-bear-beret.cyclic.app/api/v1/fees/getFeeStatus", {
  //     withCredentials: true,
  //     headers: {
  //       Authorization: `Bearer ${authToken}`,
  //     },
  ...
  useEffect(() => {
    axios
      .get(
        `https://handsome-bear-beret.cyclic.app/api/v1/fees/getFeeStatus?studentId=${studentData._id}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
