...
const Api_Create = "https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/createAssignment";
const Api_Update = "https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/updateAssignment/";
const Api_GetAssiignment = "https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/getAllAssignment";
const Api_GetAll ="https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/getAllClass";
const API_DELETE = "https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/deleteAssignment/6538e0fb0c6aa38bbddec27b";
...
const Assignments = () => {
 ...
 const [showAssignment, setShowAssignment] = useState(false);
  ...
  useEffect(() => {
    axios.get("https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/getAllClass", {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  useEffect(() => {
    axios.get("https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/getAllAssignment", {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  const handleDeleteAssignment = (index) => {
    ...
    axios
      .delete("https://handsome-bear-beret.cyclic.app/api/v1/adminRoute/deleteAssignment/" + assignmentId, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
