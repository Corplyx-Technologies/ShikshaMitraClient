...
const CreateExams = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://real-ruby-dolphin-fez.cyclic.app/api/v1/exam/getAllExams?className=${data.classTeacher}&section=${data.section}`, {
  ...
  const handleDelete= async (id)=>{
    ...
    try {
      const response = await axios.delete(`https://real-ruby-dolphin-fez.cyclic.app/api/v1/exam/deleteExam/${id}`, {
        withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post("https://real-ruby-dolphin-fez.cyclic.app/api/v1/exam/createExam", formData, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
