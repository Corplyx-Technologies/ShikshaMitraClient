...
const Lectures = () => {
  ...
  useEffect(() => {
    axios.get(`https://real-ruby-dolphin-fez.cyclic.app/api/v1/timeTable/getClassTimeTable?className=${data.classTeacher}&section=${data.section}` , {
  ...
  const handleSubmit = async () => {
      ...
      await axios
      .post("https://real-ruby-dolphin-fez.cyclic.app/api/v1/timeTable/createClassTimeTable", formattedTimetable, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  const handleDelete = async() => {
    ...
    // https://real-ruby-dolphin-fez.cyclic.app/api/v1/timeTable/deleteClassTimeTable/65449334131ddb58cb6de7f6
    await axios
      .delete(`https://real-ruby-dolphin-fez.cyclic.app/api/v1/timeTable/deleteClassTimeTable/${timetableId}`, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-4xl font-bold mb-4 uppercase text-center  hover-text">School Dashboard</h1>
