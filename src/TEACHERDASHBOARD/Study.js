...
const API_BASE_URL="https://precious-pink-nightgown.cyclic.app/api/v1/teacher"
  const API_POST_URL = "https://precious-pink-nightgown.cyclic.app/api/v1/createStudyMaterial";
const API_DELETE = "https://precious-pink-nightgown.cyclic.app/api/v1/adminRoute/deleteNotice/";
const API_GET_DATA = "https://precious-pink-nightgown.cyclic.app/api/v1/deleteStudyMaterial";
