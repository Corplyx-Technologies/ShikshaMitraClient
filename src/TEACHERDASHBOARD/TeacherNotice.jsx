...
// const API_BASE_URL = "https://tiny-tan-wombat-shoe.cyclic.app/api/v1/adminRoute/createNotice";
// const API_EDIT = "https://tiny-tan-wombat-shoe.cyclic.app/api/v1/adminRoute/updateNotice/";
// const API_DELETE = "https://tiny-tan-wombat-shoe.cyclic.app/api/v1/adminRoute/deleteNotice/";
...
//       <h1 className="text-xl font-bold text-cyan-700 mb-4">Notice Board</h1>
...
//             <h2 className="text-xl font-bold text-cyan-700 mb-4">{notice.title}</h2>
