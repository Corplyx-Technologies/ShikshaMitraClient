...
const ActivePieChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://precious-pink-nightgown.cyclic.app/api/v1/adminRoute/getAllStudentStatus', {
  ...
  return (
    <>
      <h1 className="text-center text-xl text-cyan-700 font-bold">Active Students</h1>
